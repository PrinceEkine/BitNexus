...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ onClose }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "BitNexus is cloud-synced via Supabase. You can log in from your phone, tablet, or PC simultaneously. Your data is protected by Row Level Security.",
